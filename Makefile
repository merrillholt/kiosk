...
.PHONY: drift sync package package-clean deploy-local deploy-local-full deploy-ssh deploy-ssh-full sync-primary-db docs docs-all docs-admin docs-clean
...
docs-admin:
	tools/print-docs.sh 11-admin-user-guide
